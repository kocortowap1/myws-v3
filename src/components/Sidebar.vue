<template>
  <div class="relative bg-white dark:bg-gray-800 overflow-auto">
      ...
      <div class="w-72 h-screen">
        ...
        <nav class="mt-10 px-6">
          ...
          >
            ...
            <span class="mx-4 text-lg font-normal"> Mahasiswa </span>
          ...
          >
            ...
            <span class="mx-4 text-lg font-normal"> Kelas </span>
            <span class="flex-grow text-right"> </span>
          </a>
          <a
            class="
          ...
          >
            ...
            <span class="mx-4 text-lg font-normal"> KRS & Nilai </span>
            <span class="flex-grow text-right"> </span>
          </a>
          <a
            class="
          ...
          >
            ...
            <span class="mx-4 text-lg font-normal"> Aktivitas Kuliah </span>
            <span class="flex-grow text-right"> </span>
          </a>
          <a
            class="
          ...
          >
            ...
            <span class="mx-4 text-lg font-normal"> Aktivitas Mahasiswa </span>
            <span class="flex-grow text-right"> </span>
          </a>
        </nav>
      </div>
